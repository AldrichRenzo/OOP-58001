...
Ent4 = Entry(window, bd=2, justify="center", bg="green")
Ent4.grid(row=1, column=0)
Ent4.insert(0, "row 1, column 0")

Ent5 = Entry(window, bd=2, justify="center", bg="green")
Ent5.grid(row=1, column=1)
Ent5.insert(0, "row 1, column 1")

Ent6 = Entry(window, bd=2, justify="center", bg="green")
Ent6.grid(row=1, column=2)
Ent6.insert(0, "row 1, column 2")

Ent7 = Entry(window, bd=2, justify="center", bg="pink")
Ent7.grid(row=2, column=0)
Ent7.insert(0, "row 2, column 0")

Ent8 = Entry(window, bd=2, justify="center", bg="pink")
Ent8.grid(row=2, column=1)
Ent8.insert(0, "row 2, column 1")

Ent9 = Entry(window, bd=2, justify="center", bg="pink")
